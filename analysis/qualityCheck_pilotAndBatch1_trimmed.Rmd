...
jyluMisc::makepdf(plotList, "oldNew_Exp_correlations_trimmed.pdf", ncol=3, nrow=3, height = 10, width = 10)
```
[oldNew_Exp_correlations_trimmed.pdf](./oldNew_Exp_correlations_trimmed.pdf)
...
# Compare with previous RNAseq data (DMSO as baseline, only Batch1 samples)
