---
title: "Quality assessment of drug perturbation RNAseq data (Batch 3 Salmon untrimmed)"
...
Pilot batch and batch 1 new
```{r,fig.width=15, fig.height=5}
plotTab_batch1 <- dplyr::filter(plotTab, batch == c("pilot", "batch1"))
