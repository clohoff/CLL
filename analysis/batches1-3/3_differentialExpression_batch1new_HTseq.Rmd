...
```{r, eval=FALSE}
DEres <- DESeq(ddsAll)
save(DEres, file = "~/Documents/R/drugseq_test/output/DEres_batch1new_htseq_20211126.RData")
```

```{r}
load("~/Documents/R/drugseq_test/output/DEres_batch1new_htseq_20211126.RData")
```
