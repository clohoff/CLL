---
title: "Processing the trimmed Salmon counted RNAseq of batch 3"
...
Read in count tables of pilot batch and batch 3
```{r}
rawFolder = "~/Documents/drugSeq/salmon_trimmed/pilot_batch3/"
...
Annotate patients
```{r}
patAnno <- readxl::read_xlsx("~/Documents/R/drugseq_test/data/RNAseq_samples_pilot_batch3.xlsx") %>%
...
Save results
```{r}
save(ddsDrug,  file = "./output/ddsDrug_trimmed_batch3_20211221.RData")
```
