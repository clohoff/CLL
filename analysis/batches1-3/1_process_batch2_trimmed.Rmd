---
title: "Processing the trimmed Salmon counted RNAseq of batch 2"
...
Read in count tables of pilot batch, batch 1 old, batch 1 new and batch 2 (aligned by Salmon)
```{r}
rawFolder = "~/Documents/drugSeq/salmon_trimmed/pilot_batch1old_batch1new_batch2/"
...
Save results
```{r}
save(ddsDrug,  file = "./output/ddsDrug_trimmed_batch2_20211213.RData")
```
