---
title: "Processing the STAR+HTseq counted RNAseq of batch 3"
...
# Read htseq results
```{r}
rawFolder = "~/Documents/drugSeq/htseq/pilot_batch1comb_batch2_batch3"
...
patAnno <- readxl::read_xlsx("./data/RNAseq_samples_pilot_batch1_batch2_batch3.xlsx") %>%
...
write_tsv(totalTab, "./output/htseq_process_batch3_andPrevious_20211220.tsv")
```

# Save results
```{r}
save(ddsDrug, file = "./output/ddsDrug_htseq_batch3_andPrevious_20211220.RData")
```
