---
title: "Processing the trimmed Salmon counted RNAseq of batch 1 new"
...
Read in count tables of pilot batch and batch 1 new (aligned by Salmon)
```{r}
rawFolder = "~/Documents/drugSeq/salmon_trimmed/pilot_batch1new/"
...
patAnno <- readxl::read_xlsx("~/Documents/R/drugseq_test/data/RNAseq_samples_pilot_batch1new.xlsx") %>%
  #mutate(fileName = str_replace(fileName, ".txt.gz","")) %>%  # not necessary for batch 1 new
...
# Save results
```{r}
save(ddsDrug,  file = "~/Documents/R/drugseq_test/output/ddsDrug_trimmed_batch1new_20211125.RData")
```
