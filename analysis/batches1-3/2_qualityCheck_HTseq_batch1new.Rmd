---
title: "Quality assessment of batch 1 new drug perturbation RNAseq data (HTseq)"
...
Load data
```{r}
load("~/Documents/R/drugseq_test/output/ddsDrug_htseq_batch1new_20211125.RData")  # named ddsDrug
