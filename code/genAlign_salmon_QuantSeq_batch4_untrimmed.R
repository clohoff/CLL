...
inputList = "~/Documents/R/drugseq_test/data/fastqFiles_batch4.txt"
rawFolder = "/g/huber/projects/nct/cll/RawData/RNASeq/drugSeq/batch4"
runTime = "04:00:00" #four hours (225 samples)
nThread = 8  #8 cores
...
# Nodes: 1
#CPU Utilized: 02:00:56
#CPU Efficiency: 64.28% of 03:08:08 core-walltime
#Job Wall-clock time: 00:23:31
#Memory Utilized: 5.56 GB
#Memory Efficiency: 92.68% of 6.00 GB
