# Generate script for submitting gene count job for batch 3 to EMLB cluster

library(tidyverse)

inputList = "./data/bamList_batch3.txt"
rawFolder = "/g/huber/projects/nct/cll/ProcessedData/RNAseq/drugSeq/bam/batch3"
...
runTime = "20:00:00" #20 hours
nThread = 1  #number of cores
nJob = 20  #number of jobs in each script

### Cluster usage report ###
# 229 samples in total, divided into 20 jobs per bash script
#Cores: 1
#CPU Utilized: 02:43:11
#CPU Efficiency: 99.51% of 02:43:59 core-walltime
#Job Wall-clock time: 02:43:59
#Memory Utilized: 187.95 MB
