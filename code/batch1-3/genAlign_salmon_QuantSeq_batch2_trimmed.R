...
nThread = 6  #6 cores (=6.00 GB memory?)
nJob = 4     #number of jobs in each script
alignMode = "A"
trimmLength = 12
...
#Nodes: 1
#Cores per node: 6
#CPU Utilized: 01:23:42
#CPU Efficiency: 73.29% of 01:54:12 core-walltime
#Memory Utilized: 5.76 GB
#Memory Efficiency: 72.01% of 8.00 GB
# --> next time use 5 scripts per script!!!
